...
class Driver(BaseDriver):
    ...
    quants = [
        ...
        QReal('Frequency Start', unit='Hz', set_cmd='SENS:SPEC:FREQ:STAR %(value)e%(unit)s', get_cmd='SENS:SPEC:FREQ:STAR?'),
        QReal('Frequency Stop', unit='Hz', set_cmd='SENS:SPEC:FREQ:STOP %(value)e%(unit)s', get_cmd='SENS:SPEC:FREQ:STOP?'),
